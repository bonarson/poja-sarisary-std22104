package com.poja.poja-sarisary-std22104.unit;
...
import com.poja.poja-sarisary-std22104.endpoint.event.EventConsumer;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("com.poja.poja-sarisary-std22104.endpoint.event.gen.UuidCreated", payload);
