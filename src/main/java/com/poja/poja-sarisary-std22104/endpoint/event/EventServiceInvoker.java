package com.poja.poja-sarisary-std22104.endpoint.event;
...
public class EventServiceInvoker implements Consumer<EventConsumer.TypedEvent> {
  ...
  public void accept(EventConsumer.TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.poja.poja-sarisary-std22104.endpoint.event.gen");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.poja.poja-sarisary-std22104.service.event."
